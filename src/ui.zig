...
// 256-color palette indices used by the "modern" scheme:
//   24  = #005f87  steel blue      (header/footer bg)
//   25  = #005faf  royal blue      (selection bg)
//   67  = #5f87af  muted blue      (graph bar)
//   73  = #5fafaf  cadet teal      (numbers)
//  110  = #87afd7  periwinkle      (directories)
//  116  = #87d7d7  pale turquoise  (keys / box titles)
//  167  = #d75f5f  soft red        (flags / errors)
//  252  = #d0d0d0  light silver    (header/footer text)
//  255  = #eeeeee  near-white      (selected-item text)
